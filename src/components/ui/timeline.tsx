  ...
  return (
    <div className="w-full md:px-10" ref={containerRef}>
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        I started my journey as a Data Science & Engineering student at Van Lang University, with a strong foundation in Python and Java development. I focus on building efficient solutions in data science, automation, and backend technologies. Currently, I'm working as a technical specialist at a university testing center, managing exam systems for students, while continuously exploring new technologies. <br /> Here&apos;s a
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              ...
              <h3 className="hidden md:block text-xl md:pl-20 md:text-5xl font-bold">
                {item.title === "October 2024 - April 2025" ? (
                  // No animations for October 2024 - April 2025
